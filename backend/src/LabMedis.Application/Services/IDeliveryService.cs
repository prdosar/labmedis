...
{
    Task<PagedResult<DeliveryDto>> GetAllAsync(int page = 1, int size = 10, long? customerId = null, DateTime? dateFrom = null, DateTime? dateTo = null, CancellationToken cancellationToken = default);
