...
public class SuppliersController : ControllerBase
{
    ...
    [HttpGet("{id:long}")]
    public async Task<ActionResult<SupplierDto>> GetById(long id, CancellationToken ct)
    {
    ...
    [HttpPut("{id:long}")]
    public async Task<ActionResult<SupplierDto>> Update(long id, [FromBody] SupplierUpdateDto dto, CancellationToken ct)
    {
