...
namespace LabMedis.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260904172644_AddDeliveryAndPaymentDelays")]
    partial class AddDeliveryAndPaymentDelays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabMedis.Domain.Entities.CustomerOrder", b =>
                {
                    ...
                    b.Property<long?>("DeliveryDelayId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("PaymentDelayId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DeliveryDelayId");

                    b.HasIndex("InvoiceId");

                    b.HasIndex("PaymentDelayId");
            ...
            modelBuilder.Entity("LabMedis.Domain.Entities.DeliveryDelay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("delivery_delays", (string)null);
                });
            ...
            modelBuilder.Entity("LabMedis.Domain.Entities.PaymentDelay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("payment_delays", (string)null);
                });
            ...
            modelBuilder.Entity("LabMedis.Domain.Entities.CustomerOrder", b =>
                {
                    ...
                    b.HasOne("LabMedis.Domain.Entities.DeliveryDelay", "DeliveryDelay")
                        .WithMany()
                        .HasForeignKey("DeliveryDelayId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("LabMedis.Domain.Entities.PaymentDelay", "PaymentDelay")
                        .WithMany()
                        .HasForeignKey("PaymentDelayId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Customer");

                    b.Navigation("DeliveryDelay");

                    b.Navigation("Invoice");

                    b.Navigation("PaymentDelay");
                });
