...
public static class DataSeeder
{
    ...
    // Toutes les valeurs sont EXPLICITES — aucun carry-forward implicite
    private static readonly (string Designation, string? Category, string? Form, string? Dosage, string? Packaging, string? TherapeuticClass, string? Supplier)[] ProductSeeds =
    {
        ...
        ("France Lait 1ér âge 900g",                   "produit infantile", "poudre",  "boite/900g",  "carton/6",   "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France Lait 2ème âge 400g",                  "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France Lait 2ème âge 900g",                  "produit infantile", "poudre",  "boite/900g",  "carton/6",   "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("Fance Lait 3ème âge 400g",                   "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France Lait 3ème âge 900g",                  "produit infantile", "poudre",  "boite/900g",  "carton/6",   "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait AR 400g",                        "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait LF 400g",                        "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("Pré France lait 400g",                       "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait confort 1er age 400g",           "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait confort 2è age 400g",            "produit infantile", "poudre",  "boite/400g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales blé-biscuité 250g",     "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales blé-miel 250g",         "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales blé-fruits 250g",       "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales riz-fuits 250g",        "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales riz-miel 250g",         "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),
        ("France lait Céréales diastases 250g",        "produit infantile", "poudre",  "boite/250g",  "carton/12",  "Lait infantile",  "CONTINENTAL COMMODITIES"),

        // ── MAIA AFRICA SAS ── Cosmétiques ────────────────────────────────────
        ("Pommade Maïa 100 ml",                        "cosmétique",  "pommade",  "boite/100ml",  "carton/72",  "anti-moustiques",  "MAIA AFRICA SAS"),
        ("Pommade Maïa 250 ml",                        "cosmétique",  "pommade",  "boite/250ml",  "carton/48",  "anti-moustiques",  "MAIA AFRICA SAS"),
        ...
        ("Mycoderme crème t/40g",                      "médicament",  "crème",   "tube/40g",    null,  "anti-fongiques",  "IBERMA"),
        ("Mycoderme 150mg ovules b/3",                 "médicament",  "ovule",   null,          null,  "anti-fongiques",  "IBERMA"),
        ("Ibertin 1g/125mg sachet b/12",               "médicament",  "poudre pour suspension buvable",  null,  null,  "anti-fongiques",  "IBERMA"),
        ("Ibertin 1g/125mg sachet b/16",               "médicament",  "poudre pour suspension buvable",  null,  null,  "anti-fongiques",  "IBERMA"),
        ("Ibertin 1g/125mg sachet b/24",               "médicament",  "poudre pour suspension buvable",  null,  null,  "anti-fongiques",  "IBERMA"),
        ("Aulcer 20mg gel b/28",                       "médicament",  "gélule",  null,          null,  "anti-fongiques",  "IBERMA"),
        ...
        ("Effermol 500mg cp b/100*10",                 "médicament",  "comprimé",  null,  null,  "antalgiques injectables",  "DEO GRATIAS GROUP"),
        ("Effermol 500mg cp b/20",                     "médicament",  "comprimé",  null,  null,  "antalgiques injectables",  "DEO GRATIAS GROUP"),
        ("Plasmolyz 20/120mg cp b/50*6",               "médicament",  "comprimé",  null,  null,  "antalgiques injectables",  "DEO GRATIAS GROUP"),
        ("Plasmolyz 80/480mg cp b/50*6",               "médicament",  "comprimé",  null,  null,  "antalgiques injectables",  "DEO GRATIAS GROUP"),
        ("Plasmolyz 80/480mg cp b/6",                  "médicament",  "comprimé",  null,  null,  "antalgiques injectables",  "DEO GRATIAS GROUP"),
        ("ABZOLE 400 MG CP B/100",                     "médicament",  "comprimé",  "boite/100 plaquettes",  "carton/36",  "antiparasitaires",  "DEO GRATIAS GROUP"),

        // ── GALPHARMA ── Médicaments (bloc 1) ────────────────────────────────
        ("ALLERGICA 10MG CPR B/30",                    "médicament",  "comprimé",  "boite/30",  "carton/54",  "anti-histaminique",            "GALPHARMA"),
        ("ALLERGICA SP F/150ML",                       "médicament",  "solution buvable",  "flacon/150ml",  "carton/36",  "anti-histaminique",  "GALPHARMA"),
        ("LEVOSTAMINE 5mg CP B/30",                    "médicament",  "comprimé",  "boite/30",  "carton/72",  "anti-histaminique",            "GALPHARMA"),
        ("CETRADOL GEL 325/37,5mg B/20",               "médicament",  "gélule",    "boite/20",  "carton/84",  "antalgiques oraux",            "GALPHARMA"),
        ("DEBRICOL CPR 100mg B/30",                    "médicament",  "comprimé",  "boite/30",  "carton/72",  "antispasmodiques",             "GALPHARMA"),
        ("GRIPEX Adulte sans sucre sachet 500mg/25mg/200mg B/12", "médicament",  "poudre pour suspension buvable",  "boite/12",  "carton/48",  "antigrippaux",  "GALPHARMA"),
        ("GRIPEX Enfant sans sucre sachet 280mg+10mg+100mg B/12", "médicament",  "poudre pour suspension buvable",  "boite/12",  "carton/48",  "antigrippaux",  "GALPHARMA"),
        ("OFLODIS CP 200mg B/20",                      "médicament",  "comprimé",  "boite/20",  "carton/25",  "antibiotiques",               "GALPHARMA"),
        ("ROMPALGINE CP 400mg/50mg/20mg B/20",         "médicament",  "comprimé",  "boite/20",  "carton/84",  "antalgiques",                 "GALPHARMA"),
        ("RUDGAL Gel 40mg B/30",                       "médicament",  "gélule",    "boite/30",  "carton/48",  "inhibiteurs de pompe à protons", "GALPHARMA"),
        ("TAMIZOL 500MG CP B/14",                      "médicament",  "comprimé",  "boite/14",  "carton/84",  "imidazolés",                  "GALPHARMA"),
        ("PECTOLYSE ADULTE SANS SUCRE 0,3% SIROP F/125ML", "médicament",  "solution buvable",  "flacon/125ml",  "carton/48",  "antitussif",  "GALPHARMA"),
        ("PECTOLYSE ENFANT 0,1% SIROP F/125ML",        "médicament",  "solution buvable",  "flacon/125ml",  "carton/48",  "antitussif",      "GALPHARMA"),
        ("DERMOCORT 0,05% CREME T/10G",                "médicament",  "crème",     "tube/10g",  "carton/100", "corticoides locaux",           "GALPHARMA"),
        ...
        ("B-PROTEI MOM 200g",  "complement alimentaire",  "poudre",  "boite/200g",  "carton/50",  "protéines alimentaires",  "B&B LIFE SCIENCE"),

        // ── GALPHARMA ── Médicaments (bloc 2 : reprend après B&B) ─────────────
        ("TRANSITON ADULTE 10G SACHET B/14",  "médicament",  "poudre pour suspension buvable",  "boite/14",  "carton/30",  "laxatifs",           "GALPHARMA"),
        ("TRANSITON ENFANT 4G SACHET B/20",   "médicament",  "poudre pour suspension buvable",  "boite/20",  "carton/30",  "laxatifs",           "GALPHARMA"),
        ("LODEPINE 5MG GELULE B/30",          "médicament",  "gélule",   "boite/30",  "carton/20",  "antihypertenseurs",  "GALPHARMA"),
        ("COPRED ODT 20MG CP ORODISPERSIBLE B/20", "médicament",  "comprimé orodispersible",  "boite/20",  "carton/72",  "corticoides oraux",  "GALPHARMA"),
        ...
        ("ABX BASOLYSE II 1L",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX CHOLESTEROL DIRECT",                "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX CLEANER 1L",                        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX CRP CONTROL LOW",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX DIFFTROL 2N",                       "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX DIFFTROL H",                        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX DIFFTROL L",                        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX DIFFTROL N",                        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX DILUENT 20L",                       "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX EOSINOFIX 1L",                      "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX FLUOCYTE 0,5L",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX LYSEBIO 0,4 L",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINICLEAN 1L",                      "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINIDIL 10L",                       "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINILYSE LMG 1L",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINOCLAIR 0,5L",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINOTROL 16 ( 2N)",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINOTROL RETIC1",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINOTROL RETIC2",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX MINOTROL RETIC3",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ALBUMIN CP",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ALP CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ALT CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA AMYLASE CP",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA AMYLASE CP",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA AST CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA BILIRUBIN DIRECT CP",        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA BILIRUBIN TOTAL CP",         "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CALCIUM AS CP",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CHLORIDE",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CHOLESTEROL CP",             "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CK 2 CONTROL",               "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CK 2 CONTROL",               "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CK MB RTU",                  "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CK MB RTU",                  "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CK NAC CP",                  "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CLEAN-CHEM CP",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CRP CAL",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA CRP CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA DEPROTEINIZER CP",           "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ENZYMATIC CREATININE CP",    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ENZYMATIC CREATININE CP",    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA ETCHING CP",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA GGT CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA GLUCOSE HK CP",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA GLUCOSE PAP CP",             "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA HDL CAL",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA HDL DIRECT CP",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA IRON CP",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA LDH CP",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA LDL CAL",                    "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA MAGNESIUM RTU",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA MULTICAL",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA N CONTROL",                  "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA N MULTICONTROL",             "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA P CONTROL",                  "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA PHOSPHORUS CP",              "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA POTASSIUM",                  "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA PRECITEST SOLUTION",         "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA REFERENCE",                  "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA SODIUM-E",                   "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA STANDARD 1",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA STANDARD 2",                 "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA STANDARD HS Cal",            "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA TOTAL PROTEINE CP",          "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA TPU CAL",                    "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA TRIGLYCERIDES CP",           "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA TRIGLYCERIDES CP",           "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA UREA CP",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA UREA CP",                    "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA URIC ACID CP",               "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA URIC ACID CP",               "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA URINARY PROTEINS CP",        "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("ABX PENTRA URINE CONTROL L/H",          "réactifs de laboratoire",  "poudre sèche",                         null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("CHILLER GLYCOL 1L",                     "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("CUVETTE SEGM, RACK P400 (P450)",        "réactifs de laboratoire",  "accessoire de laboratoire",            null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("KIT.MAINTENANCE MICROS",                "réactifs de laboratoire",  "matériel de maintenance",              null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("MEBFIL 100MG/5ML SUSP BUV FL/30ML",    "réactifs de laboratoire",  "suspension buvable",                   null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("NEEDLE , REAGENT WITH PIPE GUIDING",    "réactifs de laboratoire",  "accessoire de laboratoire",            null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("NEEDLE , SAMPLE P400 W FERRITE",        "réactifs de laboratoire",  "aiguille de prélèvement",              null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("OMNIPAQUE 350 MGI/ML",                  "réactifs de laboratoire",  "solution injectable",                  null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("OPTICAL HALOGEN P400",                  "réactifs de laboratoire",  "consommable technique",                null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("OPTICAL LAMP P400",                     "réactifs de laboratoire",  "consommable technique",                null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("REAGENT SYRINGE (1000 µL)",             "réactifs de laboratoire",  "accessoire de rechange pour analyseur",null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("REDIN PLUS CAPS B/30",                  "réactifs de laboratoire",  "gélule",                               null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("SAMPLE CUP-BLUE",                       "réactifs de laboratoire",  "accessoire de laboratoire",            null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("SAMPLE SYRIGE (100 #L)",                "réactifs de laboratoire",  "accessoire de rechange pour analyseur",null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("TOOL, LATEX FLUO",                      "réactifs de laboratoire",  "accessoire de laboratoire",            null,  null,  "réactifs de laboratoire",  "HORIBA"),
        ("WHITEDIFF 1L",                          "réactifs de laboratoire",  "solution liquide",                     null,  null,  "réactifs de laboratoire",  "HORIBA"),
    };
}
