...
import { Search, X, Eye, Plus, RotateCcw, Printer } from 'lucide-react'
          ...
          <DataTable
            ...
            actions={r => (
              <div className="flex items-center gap-1">
                {r.customerOrderId && (
                  <button title="Imprimer la facture" onClick={() => navigate(`/orders/customers/${r.customerOrderId}?print=facture`)}
